# Pitfalls en producción y extensiones
...
Como material complementario, el libro incluye: [Ap-1 — Software para MMM → MTA](91-ap-1-sw-para-MTA.qmd) (ecosistema y *stack* típico), [Ap-2 — Whitepaper para CXOs (EN)](92-ap-2-doc-CXOs.qmd) (versión ejecutiva y Q&A defensivo), [Blog post (Head of Data Science)](95-blog-post-DS.qmd) (encuadre DS con apéndice técnico) y la [Biblio anotada](99-biblio-anotada.qmd).
