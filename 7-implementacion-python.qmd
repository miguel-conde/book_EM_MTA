# Implementación en Python: E-step vectorizado + M-step (GLM con offset)
...
Para la interpretación de $w$/*exposure* y su uso como *offset* en el M-step (GLM con enlace log), véase el [Ap-3 — Exposición y offset: nomenclatura e interpretación](93-ap-3-exposure.qmd).

Para una vista práctica del ecosistema de software y del *stack* típico MMM→MTA (MMM off-the-shelf + capa EM *custom*), véase [Ap-1 — Software para MMM → MTA](91-ap-1-sw-para-MTA.qmd).
