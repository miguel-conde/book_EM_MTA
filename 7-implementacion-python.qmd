...
-   **EM completo**:
    ...
    -   **M-step**: GLM Poisson con link log y **offset** `log(w_tilde)`, implementado con **IRLS** + **ridge**
...
- El *E-step* se implementa de forma vectorizada y garantiza la conservación de masa por brick: $\sum_{h\in b}\hat z_{h,b}=y_b$.
- El *M-step* se resuelve como GLM Poisson con link log y *offset* `log(w_tilde)`, estimado con IRLS y regularización ridge.
