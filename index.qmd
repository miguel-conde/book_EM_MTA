...
El notebook `em_hcp_brick_end_to_end.ipynb` muestra un flujo completo para:
...
El notebook `em_mmm_to_mta_adstock_saturation.ipynb` muestra un flujo completo para:
