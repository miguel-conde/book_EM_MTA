# Multitouch Attribution as a Latent Variable Problem: A Data Science Perspective

*Attribution debates often fail not because models are wrong,
but because the problem is framed incorrectly.*

For data science teams, Multitouch Attribution (MTA) is frequently presented as a modeling choice: rules vs machine learning, heuristics vs deep learning, paths vs graphs.
...
This is not a machine learning problem in the classical sense.
It is a **constrained inference problem**.
...
The E-step computes expected allocations under current parameters.
The M-step updates relative efficiencies.

Crucially:

> **EM preserves mass by construction.**

This single property eliminates many reconciliation issues common in attribution systems.
...
Below is a **Technical Appendix** you can attach to the whitepaper or link as a separate document.
It is written for **Heads of Data Science / senior DS**, with **formal equations** and **implementation-ready pseudo-code**, but still scoped to be readable and defensible.
